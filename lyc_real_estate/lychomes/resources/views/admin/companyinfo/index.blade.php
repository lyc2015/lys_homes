                    ...
                    <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <span title="">
                                        {{ str_limit($companyinfo->content['title']) }}
                                    </span>
                                </td>
                                <td>
                                    <span title="">
                                        {{ str_limit($companyinfo->content['cover_image_link']) }}
                                    </span>
                                <td>
                                    {{ $companyinfo->content['cover_image_intro'] }}
                                </td>
                                <td>
...
<!--
                                    <button type="button" class="btn btn-danger btn-sm waves-effect"
                                        onclick="deletePost({{$companyinfo->id}})">
                                        <i class="material-icons">delete</i>
                                    </button>
                                    <form action="{{route('admin.companyinfo.destroy',$companyinfo->id)}}" method="POST"
                                        id="del-post-{{$companyinfo->id}}" style="display:none;">
                                        @csrf
                                        @method('DELETE')
                                    </form>
-->
