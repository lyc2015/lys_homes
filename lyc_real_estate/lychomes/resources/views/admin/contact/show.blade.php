...
{{$content['wechat_image_link']}}
                    ...
                    <div class="form-group form-float">
                        <div class="form-line">
                            <input type="text" name="wechat_intro" class="form-control" value="{{$content['wechat_intro']}}"  disabled="true">
                            <label class="form-label">
                                <span class="red-star">&#9733;</span>    
                                Wechat账号说明
                            </label>
...
{{$content['line_image_link']}}
                    ...
                    <div class="form-group form-float">
                        <div class="form-line">
                            <input type="text" name="line_intro" class="form-control" value="{{$content['line_intro']}}"  disabled="true">
                            <label class="form-label">
                                <span class="red-star">&#9733;</span>    
                                Line账号说明
                            </label>
        ...
        <div class="card">
            <div class="body">
                <a href="{{route('admin.contact.index')}}" class="btn btn-danger btn-lg waves-effect">
                    <i class="material-icons left">arrow_back</i>
                    <span>BACK</span>
                </a>
                <a href="{{route('admin.contact.edit',$contact->id)}}" class="btn btn-danger btn-lg waves-effect">
