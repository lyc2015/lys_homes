...
<div class="row clearfix">
    <form action="{{route('admin.organization.update',$companyinfo->id)}}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
            ...
            <div class="card">
                ...
                <div class="body">
                    ...
                    <div class="form-group form-float">
                        ...
                        <div class="form-line">
                            <input type="file" name="organization_image" class="form-control" value=""/>
    {{$content['organization_image_link']}}
                        </div>
                    </div>
                    <div class="form-group form-float">
                        <label class="form-label">
                        ...
                        <div class="form-line">
                            <input type="file" name="organization_file" class="form-control" value=""/>
    {{$content['organization_file_link']}}
                        </div>
                    </div>
