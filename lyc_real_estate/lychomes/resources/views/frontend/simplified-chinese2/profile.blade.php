			...
			<div class="block_inner content1">
				...
				<div class="segment clearfix">
					...
					<div class="img-area img-right">
						<img src="{{ asset('index2/img/simplified-chinese/profile/segment-1.png') }}" alt="中介事业">
					</div>
		...
		<div class="content_block width_full clearfix">
			<div class="block_inner content2">
				...
				<div class="segment clearfix">
					...
					<div class="img-area img-right">
						<img src="{{ asset('index2/img/simplified-chinese/profile/segment-2.png') }}" alt="資產管理解決方案事業">
					</div>
		...
		<div class="content_block width_full clearfix">
			<div class="block_inner content3">
				...
				<div class="segment clearfix">
					...
					<div class="img-area img-right">
						<img src="{{ asset('index2/img/simplified-chinese/profile/segment-3.png') }}" alt="租赁管理事业">
					</div>
