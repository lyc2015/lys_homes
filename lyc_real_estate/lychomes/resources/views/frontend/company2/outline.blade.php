...
@section('styles')
    <link rel="stylesheet" type="text/css" href="{{ asset('index2/css/company/outline.css') }}" />
@endsection
				...
				<table class="table-outline">
					<tbody>
						...
						<tr>
							...
							<td>{!!$content['company_adress']!!}<br><a href="#anc01" class="target_map js_link_in_page">地図はこちら</a>
							</td>
						</tr>
						<tr>
							<th class="title">法人番号</th>
							<td>{!!$content['legal_person_code']!!}</td>
						</tr>
						<tr>
							<th class="title">適格請求書発行事業者<br>登録番号</th>
							<td>{!!$content['login_code']!!}</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td>{!!$content['register_capital']!!}</td>
						</tr>
						<!-- <tr>
						...
						<tr>
							...
							<td>{!!$content['employee_count']!!}</td>
						</tr>
						<tr>
							<th class="title">代表者</th>
							<td>
								<dl class="officer">
									<dt>{!!$content['legal_person']!!}</dt>
									<dd></dd>
								</dl>
							</td>
						</tr>
						...
						<tr>
							...
							<td>{!!$content['license_number']!!}</td>
						</tr>
						<tr>
							<th class="title">事業内容</th>
							<td>{!!$content['business_content']!!}</td>
						</tr>
						<!-- <tr>
