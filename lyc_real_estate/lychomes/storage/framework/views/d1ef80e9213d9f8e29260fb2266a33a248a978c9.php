            ...
            <div class="block_inner content1">
                ...
                <div class="list_wrap">
                    <ul class="list-mini_content_link row-3">
                        <li>
                            <a href="<?php echo e(route('company', ['subpage' => 'philosophy',])); ?>" class="anime-wrap">
                                ...
                                <div class="img-area">
                                    <div class="img-cap-wrap">
                                        <img src="<?php echo e(asset('/index2/img/company/mini_content_link1-1.jpg')); ?>" alt="企業理念・ごあいさつ" class="img">
                                    </div>
                                </div>
                        ...
                        <li>
                            <a href="<?php echo e(route('company', ['subpage' => 'outline',])); ?>" class="anime-wrap">
                                <div class="kazari-wrap anime anime-in">
                                ...
                                <div class="img-area">
                                    <div class="img-cap-wrap">
                                        <img src="<?php echo e(asset('/index2/img/company/mini_content_link1-2.jpg')); ?>" alt="会社概要" class="img">
                                    </div>
                                </div>
                                <div class="txt-wrap anime anime-in">
                        ...
                        <li>
                            <a href="<?php echo e(route('company', ['subpage' => 'history',])); ?>" class="anime-wrap">
                                <div class="kazari-wrap anime anime-in">
                                ...
                                <div class="img-area">
                                    <div class="img-cap-wrap">
                                        <img src="<?php echo e(asset('/index2/img/company/mini_content_link1-3.jpg')); ?>" alt="沿革" class="img">
                                    </div>
                                </div>
                                <div class="txt-wrap anime anime-in">
                        ...
                        <li>
                            <a href="<?php echo e(route('company', ['subpage' => 'organization',])); ?>" class="anime-wrap">
                                <div class="kazari-wrap anime anime-in">
                                ...
                                <div class="img-area">
                                    <div class="img-cap-wrap">
                                        <img src="<?php echo e(asset('/index2/img/company/mini_content_link1-4.jpg')); ?>" alt="組織図" class="img">
                                    </div>
                                </div>
                                <div class="txt-wrap anime anime-in">
                        ...
                        <li>
                            <a href="<?php echo e(route('company', ['subpage' => 'release',])); ?>" class="anime-wrap">
                                <div class="kazari-wrap anime anime-in">
                                ...
                                <div class="img-area">
                                    <div class="img-cap-wrap">
                                        <img src="<?php echo e(asset('/index2/img/company/mini_content_link1-5.jpg')); ?>" alt="ニュースリリース" class="img">
                                    </div>
                                </div>
                                <div class="txt-wrap anime anime-in">
                        ...
                        <li>
                            <a href="<?php echo e(route('company', ['subpage' => 'business',])); ?>" class="anime-wrap">
                                <div class="kazari-wrap anime anime-in">
                                ...
                                <div class="img-area">
                                    <div class="img-cap-wrap">
                                        <img src="<?php echo e(asset('/index2/img/company/mini_content_link1-6.jpg')); ?>" alt="事業案内" class="img">
                                    </div>
                                </div>
                                <div class="txt-wrap anime anime-in">
