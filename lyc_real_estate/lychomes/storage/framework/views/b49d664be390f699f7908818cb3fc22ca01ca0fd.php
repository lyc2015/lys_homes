		...
		<div class="content_block width_full clearfix">
			<div class="block_inner content1">
				...
				<div class="img-txt yakuwari clearfix">
					<div class="img-area">
						<img src="<?php echo e(asset('index2/img/company/business/maru.png')); ?>" alt="東京建物不動産販売の役割" />
					</div>
					<div class="txt-area">
				...
				<div class="list_wrap">
					<ul class="list-normal_card" style="pointer-events: none">
						...
						<li class="item-normal_card">
							<a href="<?php echo e(route('company.business', ['subpage' => 'chukai',])); ?>">
								<div class="img_wrap">
									<img src="<?php echo e(asset('index2/img/company/business/normal_card1-1.jpg')); ?>" alt="仲介事業" />
								</div>
						...
						<li class="item-normal_card">
							<a href="<?php echo e(route('company.business', ['subpage' => 'solution',])); ?>">
								<div class="img_wrap">
									<img src="<?php echo e(asset('index2/img/company/business/normal_card1-2.jpg')); ?>" alt="アセットソリューション事業" />
								</div>
								<p class="normal_card-title">
						...
						<li class="item-normal_card">
							<a href="<?php echo e(route('company.business', ['subpage' => 'chintai',])); ?>">
								<div class="img_wrap">
									<img src="<?php echo e(asset('index2/img/company/business/normal_card1-3.jpg')); ?>" alt="賃貸事業" />
								</div>
								<p class="normal_card-title">
									<span>賃貸事業</span>
								</p>
