            ...
            <div class="body">
                <div class="table-responsive">
                    <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $article): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td><?php echo e($article->id); ?></td>
                                <td>
                                    <span title="<?php echo e($article->cover_title); ?>">
                                        <?php echo e(str_limit($article->cover_title)); ?>

                                    </span>
                                </td>
                                <td>
                                    <span title="<?php echo e($article->cover_intro); ?>">
                                        <?php echo e(str_limit($article->cover_intro)); ?>
                                ...
                                <td>
                                    <?php echo e($article->updated_at->format('Y-m-d H:i:s')); ?>

                                </td>

                                <td class="text-center">
                                    <a href="<?php echo e(route('admin.article.show',$article->id)); ?>"
                                        class="btn btn-success btn-sm waves-effect">
                                        <i class="material-icons">visibility</i>
                                    </a>
                                    <a href="<?php echo e(route('admin.article.edit',$article->id)); ?>"
                                        class="btn btn-info btn-sm waves-effect">
                                        <i class="material-icons">edit</i>
                                    </a>
                                    <button type="button" class="btn btn-danger btn-sm waves-effect"
                                        onclick="deletePost(<?php echo e($article->id); ?>)">
                                        <i class="material-icons">delete</i>
                                    </button>
                                    <form action="<?php echo e(route('admin.article.destroy',$article->id)); ?>" method="POST"
                                        id="del-post-<?php echo e($article->id); ?>" style="display:none;">
                                        <?php echo csrf_field(); ?>
