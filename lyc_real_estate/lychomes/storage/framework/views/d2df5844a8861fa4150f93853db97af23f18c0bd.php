...
<div class="row clearfix">
    <form action="<?php echo e(route('admin.corporatezh.store')); ?>" method="POST" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="card">
                ...
                <div class="body">
                    <div class="form-group form-float">
                        <div class="form-line">
                            <input type="text" name="title_outline" class="form-control" value="" required>
                            <label class="form-label">
                                <span class="red-star">&#9733;</span>    
                                标题
                            </label>
                    ...
                    <div class="form-group form-float">
                        ...
                        <div class="form-line">
                            <textarea class="form-control" name="company_name" rows="3" required></textarea>
                        </div>
                    </div>
                    <div class="form-group form-float">
                        <label class="form-label">
                        ...
                        <div class="form-line">
                            <textarea class="form-control" name="company_adress" rows="3" required></textarea>
                        </div>
                    </div>
                    <div class="form-group form-float">
                        <label class="form-label">
                        ...
                        <div class="form-line">
                            <textarea class="form-control" name="capital" rows="3" required></textarea>
                        </div>
                    </div>
                    <div class="form-group form-float">
                        <label class="form-label">
                        ...
                        <div class="form-line">
                            <textarea class="form-control" name="revenue" rows="3" required></textarea>
                        </div>
                    </div>
                    <div class="form-group form-float">
                        <label class="form-label">
                        ...
                        <div class="form-line">
                            <textarea class="form-control" name="establish_time" rows="3" required></textarea>
                        </div>
                    </div>
                    <div class="form-group form-float">
                        <label class="form-label">
                        ...
                        <div class="form-line">
                            <textarea class="form-control" name="legal_person" rows="3" required></textarea>
                        </div>
                    </div>
                    <div class="form-group form-float">
                        <label class="form-label">
                        ...
                        <div class="form-line">
                            <textarea class="form-control" name="business" rows="3" required></textarea>
                        </div>
                    </div>
                    <div class="form-group form-float">
                        <label class="form-label">
                        ...
                        <div class="form-line">
                            <textarea class="form-control" name="mother_company" rows="3" required></textarea>
                        </div>
                    </div>
                   <div class="form-group form-float">
                        <label class="form-label">
                        ...
                        <div class="form-line">
                            <textarea class="form-control" name="affiliation" rows="3" required></textarea>
                        </div>
                    </div>
                </div>
            </div>
            <div class="card">
                ...
                <div class="body">
                    <div class="form-group form-float">
                        <div class="form-line">
                            <input type="text" name="title_history" class="form-control" value="" required>
                            <label class="form-label">
                                <span class="red-star">&#9733;</span>    
                                标题
                            </label>
