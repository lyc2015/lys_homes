            ...
            <div class="block_inner content1">
                ...
                <div class="list_wrap">
					...
					<?php $__currentLoopData = $list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $info): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li>
                            <a href="<?php echo e(route('company.show',$info->id)); ?>" class="anime-wrap">
                                <div class="kazari-wrap anime anime-in">
                                    <h4 class="txt1 theme_font"><?php echo e($info->cover_title); ?></h4>
                                    <h4 class="txt2 theme_font"><?php echo e($info->cover_title_en); ?></h4>
                                </div>
                                <div class="img-area">
                                    <div class="img-cap-wrap">
                                        <img src="/<?php echo e($info->cover_image->file_link); ?>" alt="<?php echo e($info->cover_intro); ?>" class="img">
                                    </div>
                                </div>
                                <div class="txt-wrap anime anime-in">
                                    <h4 class="title"><?php echo e($info->cover_intro); ?></h4>
                                </div>
                            </a>
                        </li>
