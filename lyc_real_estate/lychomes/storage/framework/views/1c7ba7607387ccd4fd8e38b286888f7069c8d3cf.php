...
<body>
        ...
        <div class="header_wrap">
            <div id="headerLogoArea" class="">
                <div class="header_logo_wrap clearfix">
                    <a href="<?php echo e(asset('/')); ?>" class="header_logo"><img src="<?php echo e(asset('index2/img/common/header_logo-other_languages.png')); ?>" alt="東京建物不動産販売"></a>
                </div>
            </div>
    ...
    <div class="js_header_change header_change">
        <div class="fixed_header js_fixed_header">
            <h1 class="light_logo"><a href="<?php echo e(asset('index2/')); ?>" class="light_logo_img"><img src="<?php echo e(asset('index2/img/common/header_logo-other_languages.png')); ?>" alt=""></a></h1>
