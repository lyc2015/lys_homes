...
<div class="row clearfix">
    <form action="<?php echo e(route('admin.contact.update', $contact->id)); ?>" method="POST" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
...
<?php echo e($content['wechat_image_link']); ?>
                    ...
                    <div class="form-group form-float">
                        <div class="form-line">
                            <input type="text" name="wechat_intro" class="form-control" value="<?php echo e($content['wechat_intro']); ?>" required>
                            <label class="form-label">
                                <span class="red-star">&#9733;</span>    
                                Wechat账号说明
                            </label>
...
<?php echo e($content['line_image_link']); ?>
                    ...
                    <div class="form-group form-float">
                        <div class="form-line">
                            <input type="text" name="line_intro" class="form-control" value="<?php echo e($content['line_intro']); ?>" required>
                            <label class="form-label">
                                <span class="red-star">&#9733;</span>    
                                Line账号说明
                            </label>
            ...
            <a href="<?php echo e(route('admin.contact.index')); ?>" class="btn btn-danger btn-lg m-t-15 waves-effect">
