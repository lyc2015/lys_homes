		...
		<div class="main_visual_parts mv_catch">
			<div class="inner">
				<h2 class="top_catch_title">
					...
					<span class="line1" style="margin-top:10%;font-weight:bold;">
						仲介手数料
						<!-- <span class="color-1 theme_font">REAL ESTATE SOLUTIONS</span> -->
					</span>
					<span class="line1" style="margin-top:1%;font-weight:bold;">
						販売：売買価格 × 1％
						<!-- <span class="color-1 theme_font">REAL ESTATE SOLUTIONS</span> -->
					</span>
					<span class="line1" style="margin-top:1%;font-weight:bold;">
			...
			<div class="news_wrap">
				...
				<div class="news">
					...
					<dl>
						...
						<dd><span><?php echo e($new->created_at->format('Y-m-d')); ?></span><a href="/company/release"><?php echo e($new->title); ?></a></dd>
					</dl>
					<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
				</div>
			</div>
		...
		<div class="block_inner content4">
			...
			<div class="content-in clearfix">
				...
				<div class="content-txts">
					...
					<div class="list_wrap" style="margin-bottom: 70px;">
