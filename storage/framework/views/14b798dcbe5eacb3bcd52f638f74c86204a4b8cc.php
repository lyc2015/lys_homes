...
<?php echo e($content['bottom_image_link']); ?>
                    ...
                    <div class="form-group form-float">
                        <div class="form-line">
                            <input type="text" name="bottom_title_left" class="form-control" value="<?php echo e($content['bottom_title_left']); ?>"  disabled="true">
                            <label class="form-label">
                                <span class="red-star">&#9733;</span>    
                                底部左侧标题
                            </label>
                    ...
                    <div class="form-group form-float">
                        <div class="form-line">
                            <input type="text" name="bottom_title_right" class="form-control" value="<?php echo e($content['bottom_title_right']); ?>"  disabled="true">
                            <label class="form-label">
                                <span class="red-star">&#9733;</span>    
                                底部右侧标题
                            </label>
                    ...
                    <div class="form-group form-float">
                        ...
                        <div class="form-line">
                            <textarea class="form-control" name="bottom_content" rows="10" disabled="true"><?php echo e($content['bottom_content']); ?></textarea>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <a href="<?php echo e(route('admin.indexzh.edit',$companyinfo->id)); ?>" class="btn btn-danger btn-lg waves-effect">
