<?php $__env->startSection('title', $purpose == "rent" ? "賃貸物件" : "販売物件"); ?>
...
<div class="row clearfix">
    <form action="<?php echo e(route('admin.properties.store')); ?>" method="POST" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
        <input type="hidden" class="form-control" name="purpose" value="<?php echo e($purpose); ?>">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            <a href="<?php echo e(route('admin.'.$purpose)); ?>" class="btn btn-danger btn-lg m-t-15 waves-effect">
