...
<body>
        ...
        <div class="header_wrap">
            <div id="headerLogoArea" class="">
                <div class="header_logo_wrap clearfix">
                    <a href="<?php echo e(asset('/')); ?>" class="header_logo">LYC不動産売買・仲介<!-- <img src="<?php echo e(asset('index2/img/common/header_logo-other_languages.png')); ?>" alt="LYC不動産販売"> --></a>
                </div>
            </div>
                ...
                <div class="header_gnav_wrap">
                    <ul class="js_header_gnav header_gnav">
                        <li class="header_gnav_item header_gnav_item-top">
                            <a href="<?php echo e(route('simplifiedChinese')); ?>" class="parent_item">公司信息首页</a>
                        </li>
                        <li class="header_gnav_item header_gnav_item-corporate">
                            <span class="parent_item"><a href="<?php echo e(route('simplifiedChinese', ['subpage' => 'corporate',])); ?>" class="js_to_investment" target="_blank">公司概要・沿革</a></span>
                        </li>
                        <li class="header_gnav_item header_gnav_item-profile">
                            <span class="parent_item"><a href="<?php echo e(route('simplifiedChinese', ['subpage' => 'profile',])); ?>" class="js_to_investment" target="_blank">业务指南</a></span>
                        </li>
                        <li class="header_gnav_item header_gnav_item-disclaimer">
                            <span class="parent_item"><a href="<?php echo e(route('simplifiedChinese', ['subpage' => 'disclaimer',])); ?>" class="js_to_investment" target="_blank">免责事项</a></span>
                        </li>
                    </ul>
                </div>
            </div>
    ...
    <div class="js_header_change header_change">
        <div class="fixed_header js_fixed_header">
            <h1 class="light_logo"><a href="<?php echo e(asset('index2/')); ?>" class="light_logo_img">LYC不動産売買・仲介<!-- <img src="<?php echo e(asset('index2/img/common/header_logo-other_languages.png')); ?>" alt=""> --></a></h1>
