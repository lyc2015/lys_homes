        ...
        <div class="header_wrap">
            <div id="headerLogoArea" class="">
                <div class="header_logo_wrap clearfix">
                    ...
                    <a href="<?php echo e(route('home')); ?>" class="header_logo">LYC不動産売買・仲介<!-- <img
                            src="<?php echo e(asset('index2/img/common/header_logo.png')); ?>" alt=""> --></a>
                </div>
            </div>
            ...
            <div id="headerMainArea" class="clearfix">
                <div class="header_gnav_wrap">
                    <ul class="js_header_gnav header_gnav">
                        ...
                        <li class="header_gnav_item header_gnav_item-top">
                            <span class="parent_item"><a href="<?php echo e(route('property', ['purpose' => 'sale',])); ?>"
                                    class="js_to_investment" target="_blank">販売物件</a></span>
                        </li>
                        <li class="header_gnav_item header_gnav_item-top">
                            <span class="parent_item"><a href="<?php echo e(route('property', ['purpose' => 'rent',])); ?>"
                                    class="js_to_investment" target="_blank">賃貸物件</a></span>
                        </li>
                        <li class="header_gnav_item header_gnav_item-top">
                            <span class="parent_item"><a href="<?php echo e(route('company')); ?>" class="js_to_investment"
                                    target="_blank">会社概要</a></span>
                        </li>
                        <li class="header_gnav_item header_gnav_item-top">
                            <span class="parent_item"><a href="<?php echo e(route('recruit')); ?>" class="js_to_investment"
                                    target="_blank">採用情報</a></span>
                        </li>
                        <li class="header_gnav_item header_gnav_item-top">
                            <span class="parent_item"><a href="<?php echo e(route('contact')); ?>" class="js_to_investment"
                                    target="_blank">お問合せ・連絡先</a></span>
                        </li>
                        <li class="header_gnav_item header_gnav_item-top">
                            <span class="parent_item"><a href="<?php echo e(route('login')); ?>" class="js_to_investment"
    ...
    <div class="js_header_change header_change">
        <div class="fixed_header js_fixed_header">
            <h1 class="light_logo">
                ...
                <a href="<?php echo e(route('home')); ?>" class="light_logo_img" style="text-decoration:none;">LYC不動産売買・仲介<!-- <img
                        src="<?php echo e(asset('index2/img/common/header_logo.png')); ?>" alt=""> --></a>
            </h1>
        ...
        <div class="footer footer_bg">
            <div class="footer-block">
                <ul class="footer-nav clearfix">
                    ...
                    <li class="ft-col-wrap ft-external_link">
                        <dl>
                            <dt><a href="<?php echo e(route('property', ['purpose' => 'sale',])); ?>"
                    ...
                    <li class="ft-col-wrap ft-external_link">
                        <dl>
                            <dt><a href="<?php echo e(route('property', ['purpose' => 'rent',])); ?>"
