...
<div class="row clearfix">
    <form action="<?php echo e(route('admin.philosophy.update',$companyinfo->id)); ?>" method="POST" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
        ...
        <div class="col-lg-8 col-md-4 col-sm-12 col-xs-12">
            <div class="card">
                ...
                <div class="body">
                    ...
                    <div class="form-group form-float">
                        <div class="form-line">
                            <input type="text" name="middle_title" class="form-control" value="<?php echo e($content['middle_title']); ?>" required>
                            <label class="form-label">
                                <span class="red-star">&#9733;</span>    
                                中间标题
                            </label>
                    ...
                    <div class="form-group form-float">
                        ...
                        <div class="form-line">
                            <textarea class="form-control" name="middle_content" rows="3"><?php echo e($content['middle_content']); ?></textarea>
                        </div>
                    </div>

                    <div class="form-group form-float">
                        <div class="form-line">
                            <input type="text" name="bottom_title" class="form-control" value="<?php echo e($content['bottom_title']); ?>" required>
                            <label class="form-label">
                                <span class="red-star">&#9733;</span>    
                                底部标题
                            </label>
                    ...
                    <div class="form-group form-float">
                        <div class="form-line">
                            <input type="text" name="bottom_title_en" class="form-control" value="<?php echo e($content['bottom_title_en']); ?>" required>
                            <label class="form-label">
                                <span class="red-star">&#9733;</span>    
                                底部标题（英文）
                            </label>
...
<?php echo e($content['bottom_image_link']); ?>
                    ...
                    <div class="form-group form-float">
                        ...
                        <div class="form-line">
                            <input type="text" name="bottom_image_intro" class="form-control" value="<?php echo e($content['bottom_image_intro']); ?>" required />
                        </div>
                    </div>
