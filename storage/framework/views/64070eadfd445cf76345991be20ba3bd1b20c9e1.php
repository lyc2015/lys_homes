...
<div class="row clearfix">
    <form action="<?php echo e(route('admin.corporatezh.update', $companyinfo->id)); ?>" method="POST" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="card">
                ...
                <div class="body">
                    <div class="form-group form-float">
                        <div class="form-line">
                            <input type="text" name="title_outline" class="form-control" value="<?php echo e($content['title_outline']); ?>" required>
                            <label class="form-label">
                                <span class="red-star">&#9733;</span>    
                                标题
                            </label>
                    ...
                    <div class="form-group form-float">
                        ...
                        <div class="form-line">
                            <textarea class="form-control" name="company_name" rows="3" required><?php echo e($content['company_name']); ?></textarea>
                        </div>
                    </div>
                    <div class="form-group form-float">
                        <label class="form-label">
                        ...
                        <div class="form-line">
                            <textarea class="form-control" name="company_adress" rows="3" required><?php echo e($content['company_adress']); ?></textarea>
                        </div>
                    </div>
                    <div class="form-group form-float">
                        <label class="form-label">
                        ...
                        <div class="form-line">
                            <textarea class="form-control" name="capital" rows="3" required><?php echo e($content['capital']); ?></textarea>
                        </div>
                    </div>
                    <div class="form-group form-float">
                        <label class="form-label">
                        ...
                        <div class="form-line">
                            <textarea class="form-control" name="revenue" rows="3" required><?php echo e($content['revenue']); ?></textarea>
                        </div>
                    </div>
                    <div class="form-group form-float">
                        <label class="form-label">
                        ...
                        <div class="form-line">
                            <textarea class="form-control" name="establish_time" rows="3" required><?php echo e($content['establish_time']); ?></textarea>
                        </div>
                    </div>
                    <div class="form-group form-float">
                        <label class="form-label">
                        ...
                        <div class="form-line">
                            <textarea class="form-control" name="legal_person" rows="3" required><?php echo e($content['legal_person']); ?></textarea>
                        </div>
                    </div>
                    <div class="form-group form-float">
                        <label class="form-label">
                        ...
                        <div class="form-line">
                            <textarea class="form-control" name="business" rows="3" required><?php echo e($content['business']); ?></textarea>
                        </div>
                    </div>
                    <div class="form-group form-float">
                        <label class="form-label">
                        ...
                        <div class="form-line">
                            <textarea class="form-control" name="mother_company" rows="3" required><?php echo e($content['mother_company']); ?></textarea>
                        </div>
                    </div>
                   <div class="form-group form-float">
                        <label class="form-label">
                        ...
                        <div class="form-line">
                            <textarea class="form-control" name="affiliation" rows="3" required><?php echo e($content['affiliation']); ?></textarea>
                        </div>
                    </div>
                </div>
            </div>
            <div class="card">
                ...
                <div class="body">
                    <div class="form-group form-float">
                        <div class="form-line">
                            <input type="text" name="title_history" class="form-control" value="<?php echo e($content['title_history']); ?>" required>
                            <label class="form-label">
                                <span class="red-star">&#9733;</span>   
                                标题
                            </label>
                    ...
                    <div class="row gallary-line story-line">
                        <div class="col-lg-5 image-line">
                           ...
                           <?php for($i = $cur_year; $i >= $start_year; $i--): ?>
                            ...
                            内容：<textarea name="intros[]" rows="2" style="width:300px;" required /><?php echo e($val); ?></textarea>
                        </div>
