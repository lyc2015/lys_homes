<?php $__env->startSection('title', "免责事项" ); ?>
...
<div class="row clearfix">
    <form action="<?php echo e(route('admin.disclaimerzh.update', $companyinfo->id)); ?>" method="POST" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
            ...
            <div class="card">
                ...
                <div class="body">
                    ...
                    <div class="form-group form-float">
                        ...
                        <div class="form-line">
                            <textarea class="form-control" name="middle_content" rows="10"><?php echo e($content['middle_content']); ?></textarea>
                        </div>
                    </div>
                </div>
            </div>
