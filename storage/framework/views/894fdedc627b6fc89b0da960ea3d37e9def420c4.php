...
<link rel="stylesheet" type="text/css" href="<?php echo e(asset('index2/css/contact.css')); ?>" />
                        ...
                        <tr>
                            <td class="no-border">
                                <div class="wc-btn top-sns-bnr-main u-cup copy-1" data-toggle="modal" data-target="#wechatModal">
                                    <img class="wc-bnr-img" src="/<?php echo e($content['wechat_image_link']); ?>" alt="WeChat">
                                    <p><span class="wc-bnr-ttl-lg">Wechat</span><br><span><?php echo e($content['wechat_intro']); ?></span></p>
                                </div>
                            </td>
                            <td class="no-border">
                                <div class="line-btn top-sns-bnr-main u-cup copy-1" data-toggle="modal" data-target="#lineModal">
                                    <img class="line-bnr-img" src="/<?php echo e($content['line_image_link']); ?>" alt="Line">
                                    <p><span class="line-bnr-ttl-lg">Line</span><br><span><?php echo e($content['line_intro']); ?></span></p>
                                </div>
                            </td>
                        </tr>
                    </tbody>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="text-center row form-group">
                        <h1 style="color:#333;"><span class="wc-modal-mainTtl">Wechat</span><br><span class="wc-modal-subTtl"><?php echo e($content['wechat_intro']); ?></span></h1>
                    </div>
                    <div class="text-center row form-group">
                        <img src="/<?php echo e($content['wechat_image_link']); ?>" alt="weChat QR code">
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="modal fade" id="lineModal" tabindex="-1" role="dialog" aria-labelledby="lineModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="text-center row form-group">
                        <h1 style="color:#333;"><span class="wc-modal-mainTtl">Line</span><br><span class="wc-modal-subTtl"><?php echo e($content['line_intro']); ?></span></h1>
                    </div>
                    <div class="text-center row form-group">
                        <img src="/<?php echo e($content['line_image_link']); ?>" alt="weChat QR code" height="80%">
                    </div>
                </div>
            </div>
        </div>
        ...
        $(document).on('submit', '#contact-us', function(e) {
            ...
            $.ajax({
                ...
                complete: function() {
                    ...
                    $(btn).empty().append('<span>送信する</span>');
                },
                dataType: 'json'
            });
