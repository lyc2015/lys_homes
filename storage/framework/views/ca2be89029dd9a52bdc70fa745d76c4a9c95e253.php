...
<!--
    <a href="<?php echo e(route('admin.philosophy.create')); ?>"
    <a href="<?php echo e(route('admin.outline.create')); ?>"
    <a href="<?php echo e(route('admin.history.create')); ?>"
    <a href="<?php echo e(route('admin.organization.create')); ?>"
    <a href="<?php echo e(route('admin.business.create')); ?>"
    <a href="<?php echo e(route('admin.release.create')); ?>"
                    ...
                    <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <span title="">
                                        <?php echo e(str_limit($companyinfo->content['title'])); ?>

                                    </span>
                                </td>
                                <td>
                                    <span title="">
                                        <?php echo e(str_limit($companyinfo->content['cover_image_link'])); ?>

                                    </span>
                                <td>
                                    <?php echo e($companyinfo->content['cover_image_intro']); ?>
...
<!--
                                    <button type="button" class="btn btn-danger btn-sm waves-effect"
                                        onclick="deletePost(<?php echo e($companyinfo->id); ?>)">
                                        <i class="material-icons">delete</i>
                                    </button>
                                    <form action="<?php echo e(route('admin.companyinfo.destroy',$companyinfo->id)); ?>" method="POST"
                                        id="del-post-<?php echo e($companyinfo->id); ?>" style="display:none;">
                                        <?php echo csrf_field(); ?>
