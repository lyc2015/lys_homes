    ...
    <form action="{{route('admin.career.update',$career->id)}}" method="POST" enctype="multipart/form-data">
        ...
        <div class="col-lg-8 col-md-4 col-sm-12 col-xs-12">
            <div class="card">
                ...
                <div class="body">
                    <input type="hidden" name="id" class="form-control" value="{{$career->id}}">
                    ...
                    <div class="form-group form-float">
                        ...
                        <div class="form-line">
                            <textarea type="text" name="intro" class="form-control" required>{{$career->intro}}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group form-float">
                        ...
                        <div class="form-line">
                            <textarea type="text" name="requirement" class="form-control" required>{{$career->requirement}}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group form-float">
                        ...
                        <div class="form-line">
                            <textarea type="text" name="work_place" class="form-control" required>{{$career->work_place}}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group form-float">
                        ...
                        <div class="form-line">
                            <textarea type="text" name="work_time" class="form-control" required>{{$career->work_time}}</textarea>
                        </div>
                    </div>
                    <div class="form-group form-float">
                        <label class="form-label">
                        ...
                        <div class="form-line">
                            <textarea type="text" name="rest_time" class="form-control" required>{{$career->rest_time}}</textarea>
                        </div>
                    </div>
                    <div class="form-group form-float">
                        <label class="form-label">
                        ...
                        <div class="form-line">
                            <textarea type="text" name="salary" class="form-control" required>{{$career->salary}}</textarea>
                        </div>
                    </div>
                    <input type="hidden" class="form-control" name="show_rank" step=1 value="{{$career->show_rank}}">
<!--
                    <div class="form-group form-float">
                        <div class="form-line">
                            <input type="hidden" class="form-control" name="show_rank" step=1 value="{{$career->show_rank}}">
