...
<div class="row clearfix">
    <form action="{{route('admin.indexzh.update', $companyinfo->id)}}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
...
{{$content['bottom_image_link']}}
                    ...
                    <div class="form-group form-float">
                        <div class="form-line">
                            <input type="text" name="bottom_title_left" class="form-control" value="{{$content['bottom_title_left']}}" required>
                            <label class="form-label">
                                <span class="red-star">&#9733;</span>    
                                底部左侧标题
                            </label>
                    ...
                    <div class="form-group form-float">
                        <div class="form-line">
                            <input type="text" name="bottom_title_right" class="form-control" value="{{$content['bottom_title_right']}}" required>
                            <label class="form-label">
                                <span class="red-star">&#9733;</span>    
                                底部右侧标题
                            </label>
