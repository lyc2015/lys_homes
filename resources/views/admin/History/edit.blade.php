...
<div class="row clearfix">
    <form action="{{route('admin.history.update',$companyinfo->id)}}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
            ...
            <div class="card">
                ...
                <div class="body">
                    ...
                    <div class="form-group form-float">
                        ...
                        <div class="form-line">
                            <textarea class="form-control" name="middle_title" rows="3">{{$content['middle_title']}}</textarea>
                        </div>
                    </div>

                    <div class="form-group form-float">
                        <div class="form-line">
                            <input type="text" name="bottom_content" class="form-control" value="{{$content['bottom_content']}}" required>
                            <label class="form-label">
                                <span class="red-star">&#9733;</span>    
                                底部内容
                            </label>
                    ...
                    <div class="row gallary-line story-line">
                        <div class="col-lg-5 image-line">
                           <select name='years[]' required>
                            ...
                            内容：<textarea name="intros[]" rows="2" style="width:300px;" required/>{{$val3}}</textarea>
                        </div>
                        <div class="col-lg-2">
...
{{$content['cover_image_link']}}
                    ...
                    <div class="form-group form-float" style="padding-bottom:20px">
                        <div class="form-line">
                            <input type="text" class="form-control" name="cover_image_intro" required value="{{$content['cover_image_intro']}}">
                            <label class="form-label">
                                <span class="red-star">&#9733;</span>
                                封面简介
                            </label>
