                        ...
                        <tr>
                            <td class="no-border">
                                <div class="wc-btn top-sns-bnr-main u-cup copy-1" data-toggle="modal" data-target="#wechatModal">
                                    ...
                                    <p><span class="wc-bnr-ttl-lg">Wechat</span><br><span>{{$content['wechat_intro']}}</span></p>
                                </div>
                            </td>
                            <td class="no-border">
                                <div class="line-btn top-sns-bnr-main u-cup copy-1" data-toggle="modal" data-target="#lineModal">
                                    ...
                                    <p><span class="line-bnr-ttl-lg">Line</span><br><span>{{$content['line_intro']}}</span></p>
                                </div>
                            </td>
                        </tr>
                    </tbody>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="text-center row form-group">
                        <h1 style="color:#333;"><span class="wc-modal-mainTtl">Wechat</span><br><span class="wc-modal-subTtl">{{$content['wechat_intro']}}</span></h1>
                    </div>
                    <div class="text-center row form-group">
    ...
    <div class="modal fade" id="lineModal" tabindex="-1" role="dialog" aria-labelledby="lineModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="text-center row form-group">
                        <h1 style="color:#333;"><span class="wc-modal-mainTtl">Line</span><br><span class="wc-modal-subTtl">{{$content['line_intro']}}</span></h1>
                    </div>
                    <div class="text-center row form-group">
