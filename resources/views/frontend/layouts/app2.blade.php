...
<head>
    ...
    <link rel="shortcut icon" href="{{ asset('index2/favicons/favicon.ico') }}">
    <link rel="apple-touch-icon" href="{{ asset('index2/favicons/favicon.png') }}">
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('index2/css/jquery.loadmask.css') }}" />
    <!-- Bootstrap Core Css -->
    <link href="{{ asset('backend/plugins/bootstrap/css/bootstrap.css') }}" rel="stylesheet">
    <link rel="stylesheet" type="text/css" href="{{ asset('slick/slick.css') }}" />
    <link rel="stylesheet" type="text/css" href="{{ asset('slick/slick-theme.css') }}" />

    <link rel="stylesheet" type="text/css" href="{{ asset('index2/css/include.css') }}" />

    @yield('styles')

    <link rel="canonical" href="{{ asset('index2/') }}" />

    <script type="text/javascript" src="{{ asset('index2/js/jquery-1.10.2.min.js') }}"></script>
    <script type="text/javascript" src="{{ asset('index2/js/jquery-migrate-1.2.1.min.js') }}"></script>
    <!-- Bootstrap Core Js -->
    <script src="{{ asset('backend/plugins/bootstrap/js/bootstrap.js') }}"></script>
    <script type="text/javascript" src="{{ asset('index2/js/jquery.accordion.js') }}"></script>
    <script type="text/javascript" src="{{ asset('index2/js/jquery.bgswitcher.js') }}"></script>
    <script type="text/javascript" src="{{ asset('index2/js/jquery.lazyload.min.js') }}"></script>
    <script type="text/javascript" src="{{ asset('index2/js/jquery.colorbox-min.js') }}"></script>
    <script type="text/javascript" src="{{ asset('index2/js/main.js') }}"></script>

    <script type="text/javascript" src="{{ asset('index2/js/common.js') }}"></script>

    <script type="text/javascript" src="{{ asset('index2/js/smartRollover.js') }}"></script>

    <script src="https://maps.googleapis.com/maps/api/js?v=3&client=gme-tatemono" type="text/javascript"
        charset="utf-8"></script>

    <script type="text/javascript" src="{{ asset('index2/js/fn.js') }}"></script>
    <script type="text/javascript" src="{{ asset('index2/js/base64.js') }}"></script>
    <script type="text/javascript" src="{{ asset('index2/js/data.js') }}"></script>
    <script type="text/javascript" src="{{ asset('index2/js/highcharts.js') }}"></script>
    <script type="text/javascript" src="{{ asset('index2/js/street_view.js') }}"></script>

    <script type="text/javascript" src="{{ asset('index2/js/smart_info_window.js') }}"></script>

    <script type="text/javascript" src="{{ asset('index2/js/google_map.js') }}"></script>
    <script type="text/javascript" src="{{ asset('slick/slick.min.js') }}"></script>

    <script type="text/javascript" src="{{ asset('index2/js/header.js') }}"></script>
...
<body>
        ...
        <div class="header_wrap">
            <div id="headerLogoArea" class="">
                <div class="header_logo_wrap clearfix">
                    <!-- <a href="{{ asset('index2/') }}" class="header_logo"><img src="{{ asset('index2/img/common/header_logo.png') }}" alt="東京建物不動産販売"></a> -->
                    <a href="{{ route('home') }}" class="header_logo">LYC不動産売買・仲介<!-- <img
                            src="{{ asset('index2/img/common/header_logo.png') }}" alt=""> --></a>
                </div>
            </div>
                ...
                <div class="header_gnav_wrap">
                    <ul class="js_header_gnav header_gnav">
                        <li class="header_gnav_item header_gnav_item-top">
                            <a href="{{ route('home') }}" class="parent_item">TOP</a>
                        </li>
                        <li class="header_gnav_item header_gnav_item-top">
                            <span class="parent_item"><a href="{{ route('property', ['purpose' => 'sale',]) }}"
                                    class="js_to_investment" target="_blank">販売物件</a></span>
                        </li>
                        <li class="header_gnav_item header_gnav_item-top">
                            <span class="parent_item"><a href="{{ route('property', ['purpose' => 'rent',]) }}"
                                    class="js_to_investment" target="_blank">賃貸物件</a></span>
                        </li>
                        <li class="header_gnav_item header_gnav_item-top">
                            <span class="parent_item"><a href="{{ route('company') }}" class="js_to_investment"
                                    target="_blank">会社概要</a></span>
                        </li>
                        <li class="header_gnav_item header_gnav_item-top">
                            <span class="parent_item"><a href="{{ route('recruit') }}" class="js_to_investment"
                                    target="_blank">採用情報</a></span>
                        </li>
                        <li class="header_gnav_item header_gnav_item-top">
                            <span class="parent_item"><a href="{{ route('contact') }}" class="js_to_investment"
                                    target="_blank">お問合せ・連絡先</a></span>
                        </li>
                        <li class="header_gnav_item header_gnav_item-top">
                            <span class="parent_item"><a href="{{ route('login') }}" class="js_to_investment"
                                    target="_blank">ログイン</a></span>
                        </li>
                    </ul>
                </div>
            </div>
    ...
    <div class="js_header_change header_change">
        <div class="fixed_header js_fixed_header">
            <h1 class="light_logo">
                <!-- <a href="{{ asset('index2/') }}" class="light_logo_img"><img src="{{ asset('index2/img/common/header_logo.png') }}" alt=""></a> -->
                <a href="{{ route('home') }}" class="light_logo_img" style="text-decoration:none;">LYC不動産売買・仲介<!-- <img
                        src="{{ asset('index2/img/common/header_logo.png') }}" alt=""> --></a>
            </h1>
            ...
            <!--
                ...
                <div class="navi_for_header_select_language_wrap">
                    <ul class="navi_for_header_select_language">
                        <li class="item-english"><a href="{{ asset('index2/english/') }}">English</a></li>
                        <li class="item-hantai"><a href="{{ asset('index2/original-chinese/') }}">中文繁体</a></li>
                        <li class="item-kantai"><a href="{{ asset('index2/simplified-chinese/') }}">中文簡体</a></li>
                    </ul>
                </div>
                            ...
                            <ul class="list-site_content">
                                ...
                                <li class="item item-2">
                                    <div class="item-body">
                                        ...
                                        <ul class="item-links">
                                            <li>
                                                <a href="{{ asset('index2/sell/') }}" class="link_button"><span class="button_label">不動産売却のご案内</span></a>
                                            </li>
                                            <li>
                                                <a href="{{ asset('index2/contact/biz_sell_satei/') }}" class="link_button"><span class="button_label">査定のご依頼はこちら</span></a>
                                            </li>
                                        </ul>
                                    </div>
                                </li>
                                ...
                                <li class="item item-3">
                                    <div class="item-body">
                                        ...
                                        <ul class="item-links">
                                            <li>
                                                <a href="{{ asset('index2/effective/') }}" class="link_button"><span class="button_label">有効活用のご案内</span></a>
                                            </li>
                                            <li>
                                                <a href="{{ asset('index2/contact/effective_consult/') }}" class="link_button"><span class="button_label">有効活用のご相談はこちら</span></a>
                                            </li>
                                        </ul>
                                    </div>
                                </li>
                        ...
                        <div class="block_inner content2">
                            ...
                            <div class="content-in clearfix">
                                ...
                                <div class="content-bg">
                                    <img src="{{ asset('index2/img/top/business_guidance_bg.jpg') }}" alt="">
                                </div>
                                    ...
                                    <div class="list_wrap">
                                        <ul class="list-txtlink clearfix">
                                            <li class="item-txtlink">
                                                <a href="{{ asset('index2/chukai/') }}" class="anime anime-1">
                                            ...
                                            <li class="item-txtlink">
                                                <a href="{{ asset('index2/company/business/solution/') }}" class="anime anime-1">
                                            ...
                                            <li class="item-txtlink">
                                                <a href="{{ asset('index2/company/business/chintai/') }}" class="anime anime-1">
                                ...
                                <div class="link_button_wrap">
                                    <a href="{{ asset('index2/company/business/cresupport/') }}" class="link_button"><span class="button_label">企業不動産（CRE）戦略について</span></a>
                                </div>
                    ...
                    <div class="content_block width_full clearfix">
                        <div class="block_inner content3">
                            ...
                            <div class="link_button_wrap clearfix">
                                <a href="{{ asset('index2/company/release/') }}" class="link_button"><span class="button_label">ニュースリリース一覧</span></a>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="content-in clearfix">
                                ...
                                <div class="content-txts">
                                    ...
                                    <div class="list_wrap">
                                        <ul class="list-txtlink clearfix">
                                            <li class="item-txtlink">
                                                <a href="{{ asset('index2/company/') }}" class="anime anime-1">
                                            ...
                                            <li class="item-txtlink">
                                                <a href="{{ asset('index2/branch/') }}" class="anime anime-1">
                                            ...
                                            <li class="item-txtlink">
                                                <a href="{{ asset('index2/recruit/') }}" class="anime anime-1">
                            ...
                            <ul class="list-normal_card">
                                <li class="item-normal_card">
                                    <a href="https://sumikae.ttfuhan.co.jp/" class="js_to_sgn" target="_blank">
                                        <img src="{{ asset('index2/img/top/related_site1-1.jpg') }}" alt="住みかえサイト">
                                ...
                                <li class="item-normal_card">
                                    <a href="https://library.ttfuhan.co.jp/" target="_blank">
                                        <img src="{{ asset('index2/img/top/related_site1-2.jpg') }}" alt="東京建物マンションライブラリー">
                                        <p class="normal_card-button">
                                ...
                                <li class="item-normal_card">
                                    <a href="https://sumikae.ttfuhan.co.jp/database/" class="js_to_database" target="_blank">
                                        <img src="{{ asset('index2/img/top/related_site1-3.jpg') }}" alt="マンションデータベース">
                                        <p class="normal_card-button">
            ...
            <div class="footer-block">
                <ul class="footer-nav clearfix">
                    ...
                    <li class="ft-col-wrap ft-external_link">
                        <dl>
                            <dt><a href="{{ route('home') }}" class="ft-link_list_title">TOP</a></dt>
                        </dl>
                    </li>
                    ...
                    <li class="ft-col-wrap ft-external_link">
                        <dl>
                            <dt><a href="{{ route('property', ['purpose' => 'sale',]) }}"
                                    class="ft-link_list_title">販売物件</a></dt>
                        </dl>
                    </li>
                    ...
                    <li class="ft-col-wrap ft-external_link">
                        <dl>
                            <dt><a href="{{ route('property', ['purpose' => 'rent',]) }}"
                                    class="ft-link_list_title">賃貸物件</a></dt>
                        </dl>
                    </li>
                    ...
                    <li class="ft-col-wrap ft-external_link">
                        <dl>
                            <dt><a href="{{ route('company') }}" class="ft-link_list_title">会社概要</a></dt>
                        </dl>
                    </li>

                    <li class="ft-col-wrap ft-external_link">
                        <dl>
                            <dt><a href="{{ route('recruit') }}" class="ft-link_list_title">採用情報</a></dt>
                        </dl>
                    </li>
                    ...
                    <li class="ft-col-wrap ft-external_link">
                        <dl>
                            <dt><a href="{{ route('contact') }}" class="ft-link_list_title">お問合せ・連絡先</a></dt>
                        </dl>
                    </li>

                    <li class="ft-col-wrap ft-external_link">
                        <dl>
                            <dt><a href="{{ route('login') }}" class="ft-link_list_title">ログイン</a></dt>
                        </dl>
                    </li>
...
-->
            ...
            <div class="footer-copy-wrap">
                <p class="copyright theme_font">Copyright &copy; LYC Estate Sales Co., Ltd.</p>
            </div>
        </div>
