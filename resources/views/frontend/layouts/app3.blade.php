...
<head>
    <meta name="description" content="投資用、事業用物件から住まいまでお探し頂けるLYC不動産販売の公式サイトです。不動産の売却、土地・建物の有効活用、社宅管理代行など、個人不動産・企業不動産（ＣＲＥ戦略）のサポートは当社にお任せください。" />
    <meta name="keywords" content="LYC不動産販売,不動産ソリューション" />
    ...
    <title>LYC不動産ソリューション｜LYC不動産販売</title>
...
<body>
    ...
    <div id="header" class="js_header_init header_init simplified-chinese_page">
        <div class="header_wrap">
            <div id="headerLogoArea" class="">
                <div class="header_logo_wrap clearfix">
                    <a href="{{ asset('/') }}" class="header_logo">LYC不動産売買・仲介<!-- <img src="{{ asset('index2/img/common/header_logo-other_languages.png') }}" alt="LYC不動産販売"> --></a>
                </div>
            </div>
                ...
                <div class="header_gnav_wrap">
                    <ul class="js_header_gnav header_gnav">
                        <li class="header_gnav_item header_gnav_item-top">
                            <a href="{{ route('simplifiedChinese') }}" class="parent_item">公司信息首页</a>
                        </li>
                        <li class="header_gnav_item header_gnav_item-corporate">
                            <span class="parent_item"><a href="{{ route('simplifiedChinese', ['subpage' => 'corporate',]) }}" class="js_to_investment" target="_blank">公司概要・沿革</a></span>
                        </li>
                        <li class="header_gnav_item header_gnav_item-profile">
                            <span class="parent_item"><a href="{{ route('simplifiedChinese', ['subpage' => 'profile',]) }}" class="js_to_investment" target="_blank">业务指南</a></span>
                        </li>
                        <li class="header_gnav_item header_gnav_item-disclaimer">
                            <span class="parent_item"><a href="{{ route('simplifiedChinese', ['subpage' => 'disclaimer',]) }}" class="js_to_investment" target="_blank">免责事项</a></span>
                        </li>
                    </ul>
                </div>
            </div>
    ...
    <div class="js_header_change header_change">
        <div class="fixed_header js_fixed_header">
            <h1 class="light_logo"><a href="{{ asset('index2/') }}" class="light_logo_img">LYC不動産売買・仲介<!-- <img src="{{ asset('index2/img/common/header_logo-other_languages.png') }}" alt=""> --></a></h1>
            <div class="light_gnav_wrap">
                <ul class="js_light_gnav light_gnav">
                    <li class="light_gnav_item light_gnav_item-top">
                        <a href="{{ route('simplifiedChinese') }}" class="parent_item">公司信息首页</a>
                    </li>
                    <li class="light_gnav_item light_gnav_item-corporate">
                        <span class="parent_item"><a href="{{ route('simplifiedChinese', ['subpage' => 'corporate',]) }}" class="js_to_investment" target="_blank">公司概要・沿革</a></span>

                    </li>
                    <li class="light_gnav_item light_gnav_item-profile">
                        <span class="parent_item"><a href="{{ route('simplifiedChinese', ['subpage' => 'profile',]) }}" class="js_to_investment" target="_blank">业务指南</a></span>

                    </li>
                    <li class="light_gnav_item light_gnav_item-disclaimer">
                        <span class="parent_item"><a href="{{ route('simplifiedChinese', ['subpage' => 'disclaimer',]) }}" class="js_to_investment" target="_blank">免责事项</a></span>
