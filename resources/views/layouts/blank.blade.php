        ...
        <div class="header_wrap">
            <div id="headerLogoArea" class="">
                <div class="header_logo_wrap clearfix">
                    ...
                    <a href="{{ route('home') }}" class="header_logo"><img src="{{ asset('index2/img/common/header_logo.png') }}" alt="東京建物不動産販売"></a>
                </div>
            </div>
            ...
            <!-- <div id="headerMainArea"> -->
                <div class="header_gnav_wrap">
                    <ul class="js_header_gnav header_gnav">
                        ...
                        <li class="header_gnav_item header_gnav_item-top">
                            <span class="parent_item"><a href="{{ route('property', ['purpose' => 'sale',]) }}" class="js_to_investment" target="_blank">販売物件</a></span>
                        </li>
                        <li class="header_gnav_item header_gnav_item-top">
                            <span class="parent_item"><a href="{{ route('property', ['purpose' => 'rent',]) }}" class="js_to_investment" target="_blank">賃貸物件</a></span>
                        </li>
                        <li class="header_gnav_item header_gnav_item-top">
                            <span class="parent_item"><a href="{{ route('company') }}" class="js_to_investment" target="_blank">会社概要</a></span>
                        </li>
                        <li class="header_gnav_item header_gnav_item-top">
                            <span class="parent_item"><a href="{{ route('recruit') }}" class="js_to_investment" target="_blank">採用情報</a></span>
                        </li>
                        <li class="header_gnav_item header_gnav_item-top">
                            <span class="parent_item"><a href="{{ route('contact') }}" class="js_to_investment" target="_blank">お問合せ・連絡先</a></span>
                        </li>
                        <li class="header_gnav_item header_gnav_item-top">
                            <span class="parent_item"><a href="{{ route('login') }}" class="js_to_investment" target="_blank">ログイン</a></span>
                        </li>
                    </ul>
                </div>
            </div>
    ...
    <div class="js_header_change header_change">
        <div class="fixed_header js_fixed_header">
            <h1 class="light_logo">
                ...
                <a href="{{ route('home') }}" class="light_logo_img"><img src="{{ asset('index2/img/common/header_logo.png') }}" alt=""></a>
            </h1>
        ...
        <div class="footer footer_bg">
            <div class="footer-block">
                <ul class="footer-nav clearfix">
                    ...
                    <li class="ft-col-wrap ft-external_link">
                        <dl>
                            <dt><a href="{{ route('property', ['purpose' => 'sale',]) }}" class="ft-link_list_title">販売物件</a></dt>
                        </dl>
                    </li>
                    ...
                    <li class="ft-col-wrap ft-external_link">
                        <dl>
                            <dt><a href="{{ route('property', ['purpose' => 'rent',]) }}" class="ft-link_list_title">賃貸物件</a></dt>
                        </dl>
                    </li>
